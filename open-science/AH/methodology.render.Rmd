...
make_check_table = function (dataset) {
  ...
  objectives = spread(dataset[,c("instance", "solver", "best_obj", "Gamma")], key = solver, value = best_obj)
...
performance_profile(results, main = "Performance profile (log-scale)", log = 'x')
```
