...
```{r}
all_results_two_stage = read.csv("results.csv", header = FALSE)
...
all_results_two_stage = all_results_two_stage %>% filter(n_facilities <= 25 & n_customers <= 40 & separation_method == "Optimality_KKT_BigM")
...
```{r}
all_results_wait_and_see = read.csv("results-wait-and-see-uflp.csv", header = FALSE)
