---
title: Open methodology for "Bilevel CCG" > Instances
output: 
  html_document:
    theme: null
...
filtered = filtered[filtered$n_follower_vars < 50,]
filtered = filtered[filtered$n_follower_ctrs < 50,]
filtered = filtered[filtered$n_leader_vars < 50,]
filtered = filtered[filtered$n_leader_ctrs < 50,]
